...
public class MainWindow extends JFrame
    ...
    private JCheckBox checkCreateSiteXML;
    ...
    public MainWindow()
        ...
        initialize();
        checkCreateSiteXML.addActionListener(new ActionListener()
        {
        @Override
        public void actionPerformed(ActionEvent e)
            {
            boolean selected = !checkCreateSiteXML.isSelected();
            checkIncludeSymbolics.setEnabled(selected);
            checkIncludeVersions.setEnabled(selected);
            checkMarkOptional.setEnabled(selected);
            comboTargetTag.setEnabled(selected);
            }
        });
        }
    ...
    private void initialize()
        ...
        public void actionPerformed(ActionEvent e)
            ...
            parser.setCreateSiteXML(checkCreateSiteXML.isSelected());
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$()
        ...
        checkCreateSiteXML = new JCheckBox();
        checkCreateSiteXML.setText("Generate site.xml");
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 7;
        gbc.anchor = GridBagConstraints.WEST;
        panel.add(checkCreateSiteXML, gbc);
